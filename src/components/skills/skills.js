...
function Skills() {
    ...
    <Box className='skills-box' >
        <Typography variant='h1' id='skills-title' >Education & skills</Typography>
        ...
        <Stack id='skill-stack-column' >
            <Stack id='skill-stack-row'>
                ...
                description='Software and web development with JavaScript and Frontend development using React, a JavaScript library for building user interfaces'
                />
            ...
            <Stack  id='skill-stack-row'>
                ...
                description='Backend development with Java using Spring, a Java framework that focus on speed, simplicity, security and productivity'
                />
            </Stack>
        </Stack>
    </Box> 
